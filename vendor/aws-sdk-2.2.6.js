        ...
        DomXmlParser.prototype.parse = function(xml, shape) {
            ...
            try {
                if (window.DOMParser) {
                    ...
                    if (isError && (isError.parentNode === result || isError.parentNode.nodeName === "body")) {
...
}, {}, [ 21 ]);AWS.apiLoader.services["cognitoidentity"] = {};
...
}, {}, [ 63 ]);AWS.apiLoader.services["cognitoidentity"]["2014-06-30"] = {
    version: "2.0",
    metadata: {
...
AWS.Lambda = AWS.Service.defineService("lambda", [ "2014-11-11", "2015-03-31" ]);AWS.apiLoader.services["lambda"]["2015-03-31"] = {
    version: "2.0",
    metadata: {
...
}, {}, [ 69 ]);AWS.apiLoader.services["s3"]["2006-03-01"] = {
    version: "2.0",
    metadata: {
...
}, {}, [ 71 ]);AWS.apiLoader.services["sts"]["2011-06-15"] = {
    version: "2.0",
    metadata: {
